    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100">
      ...
      <div className="w-full max-w-md">
        <div className="mb-6 rounded-lg bg-white px-8 pb-8 pt-10 shadow-lg">
          <h2 className="mb-8 text-center text-3xl font-bold text-gray-800">Forgot Password</h2>
          <form>
            <div className="mb-6">
            ...
            <div className="mb-9 flex items-center justify-center">
              <button className="focus:shadow-outline rounded-lg bg-blue-600 px-24 py-4 font-bold text-white hover:bg-blue-700 focus:outline-none" type="submit">Send Reset Link</button>
            </div>
            <div className="mb-4 flex items-center justify-center">
              <a className="inline-block align-baseline text-sm font-semibold text-blue-600 hover:text-blue-700" href="/login"> Back to Login </a>
            </div>
          </form>
        </div>
